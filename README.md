...
![ScreenShot](https://i.imgur.com/0kTJ3cU.png)
...
1. Install `TodoReview` via Package Control.
...
- **Report Headers** are the same color as a _comment_
- **Pattern Titles** are the same color as a _string_
- **Line Numbers** are the same color as a _function_
- **Priority** are the same color as a _variable_
- **Bracket Tags** are the same color as a _class_
- **@Tags** are the same color as a _keyword_
